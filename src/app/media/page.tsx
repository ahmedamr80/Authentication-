        ...
        <div className="min-h-screen bg-gray-950 text-white pb-24">
            ...
            <main className="pt-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-6">
                ...
                {loading && items.length === 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center text-center py-16 px-4 bg-gray-900/40 rounded-2xl border border-gray-800 shadow-2xl relative overflow-hidden backdrop-blur-sm">
                        <div className="relative mb-6">
                            ...
                            <div className="relative p-5 bg-gray-900 rounded-full border border-gray-800 shadow-xl">
                                <ImageIcon className="w-10 h-10 text-gray-400 opacity-60" />
                            </div>
                        </div>
                        <h3 className="text-xl font-semibold text-white mb-2">No Images Uploaded</h3>
                        <p className="text-gray-400 text-sm max-w-sm mb-8">
                            Your media library is empty. Upload images here to easily select them when creating events or updating your profile.
                        </p>
                        <Button 
