...
const CACHE_NAME = 'ewp-cache-v3'; // Increment version for updates
const STATIC_ASSETS = [
    '/',
    '/manifest.json',
    '/logo.svg',
...
if (!firebase.apps.length && firebaseConfig.apiKey) {
    ...
    messaging.onBackgroundMessage((payload) => {
        ...
        const notificationTitle = payload.notification?.title || payload.data?.title || 'Padel Tournament';
        const notificationOptions = {
            ...
            sound: payload.notification?.sound || '/sounds/notification.wav',
            data: {
